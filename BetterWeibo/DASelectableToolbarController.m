...
{
    _replacedView = [self.subviews lastObject];
...
//        AKToolBarItemView *newToolbarItemView = [[AKToolBarItemView alloc] initWithFrame:NSMakeRect(0, 0, 53, 53)];
//        newToolbarItemView.enclosingToolbarItem = _toolbarItem;
//        [_toolbarItem setView:newToolbarItemView];
